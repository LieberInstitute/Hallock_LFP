function [tf, tfZ, tf_smooth] = morlet_spectrogram(sample, srate, lowpass, highpass, plot)
...
tfZ = zscore(tf);
times = linspace(-(srate*5),srate*5,length(sample)/srate);
